...
subtitle: The key word that I was missing all along
...
Thanks to `masukomi` from Hacker News I am now made aware of Forestry. It is called a CMS guys. And adding that keyword threw up a bunch of other options as well. But Forestry is a beauty, took me just minutes to setup it up. I am ignoring a couple hours spent debugging an issue with my Jekyll setup that prevented the Forestry systems from building my site for Auto Preview. Actually better make note of that.

If your build is failing due to the folowing error:
